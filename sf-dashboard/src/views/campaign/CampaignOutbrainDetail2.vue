...
import LanguageSingle from '@/components/campaign/modules/LanguageSingle.vue'
...
import MSN from '@/components/campaign/modules/outbrain/MSN.vue'
import HighImpact from '@/components/campaign/modules/outbrain/HighImpact.vue'
import ExcludeAdBlock from '@/components/campaign/modules/outbrain/ExcludeAdBlock.vue'

const traffic_source = TS.OUTBRAIN
    ...
    <div class="flex flex-col flex-1 mb-4">
      <div class="campaign space-y-4" v-show="statusData.IsTabCampaign()">
        ...
        >
          ...
          <CampaignOBBidding :campaign="campaign" :FreezeData="FreezeData" />

          <CampaignModuleBudget :campaign="campaign" />

          <Location :campaign="campaign" :FreezeData="FreezeData" />

          <LanguageSingle :campaign="campaign" :FreezeData="FreezeData" />
        </n-card>
        <n-card
          title="Outbrain"
          class="card-flex-gap-4 rounded-[5px] !border-gray2"
        >
          <MSN :campaign="campaign" :FreezeData="FreezeData" />
          <HighImpact :campaign="campaign" :FreezeData="FreezeData" />
          <ExcludeAdBlock :campaign="campaign" :FreezeData="FreezeData" />
        </n-card>
...
@/components/campaign/composables/campaign
