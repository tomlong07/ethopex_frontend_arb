...
import Placements from '@/components/campaign/modules/pocpoc/Placements.vue'
import Targeting from '@/components/campaign/modules/pocpoc/Targeting.vue'
import Inventories from '@/components/campaign/modules/pocpoc/Inventories.vue'
import AdCreative from '@/components/campaign/modules/general/AdCreative.vue'
import DomainKeywordManager from '@/components/campaign/modules/DomainKeywordManager.vue'
import KeywordManager from '@/components/campaign/modules/KeywordManager.vue'
import RelatedSearchAd from '@/components/campaign/modules/RelatedSearchAd.vue'

const traffic_source = TS.POCPOC
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            ...
            <CreateCampaign
              ...
              :statusData="statusData"
            />
            <CampaignPPocType :campaign="campaign" :FreezeData="FreezeData" />
            ...
            <CreateLandingPageByCreative
              ...
              :statusData="statusData"
            />
            <RelatedSearchAd :campaign="campaign" />
            <Tag
              :campaign="campaign"
              :statusData="statusData"
              v-if="statusData"
          ...
          <n-card
            ...
            class="card-flex-gap-4 rounded-[5px] !border-gray2"
            v-if="campaign.related_search_ad === 'on'"
          >
            <div class="flex flex-col gap-4">
              <DomainKeywordManager :campaign="campaign" />
              <KeywordManager :campaign="campaign" />
            </div>
          </n-card>
          <n-card
            title="Targeting"
          ...
          >
            <Device :campaign="campaign" :FreezeData="FreezeData" />
          ...
          >
            ...
            <Placements :campaign="campaign" />
            <Targeting :campaign="campaign" />

            <Inventories :campaign="campaign" />
          </n-card>
        </div>
        <div class="flex flex-col gap-4">
          <n-card
