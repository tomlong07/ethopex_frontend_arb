    ...
    <div class="flex flex-row flex-1 justify-between">
      <div class="font-bold text-xs text-gray-500">
        <div class="flex font-bold text-xs items-center">
          Column Display:
          <n-switch
            v-model:value="reportSupplyKeywordStore.isColumnDisplay"
        ...
        <n-collapse-transition :show="reportSupplyKeywordStore.isColumnDisplay">
          <div class="flex w-full mt-3">
            <n-checkbox-group
              v-model:value="reportSupplyKeywordStore.listMetricsColumnAccepted"
            ...
            >
              <div class="flex gap-2 items-center">
                ...
                <n-button
                  size="tiny"
                  @click="reportSupplyKeywordStore.toggleAllMetrics"
              ...
              <div class="flex flex-wrap gap-2">
                <div
                  v-for="(o, i) in reportSupplyKeywordStore.metricsColumn"
                  :key="i"
                  class="w-40"
                >
                  <n-popover
